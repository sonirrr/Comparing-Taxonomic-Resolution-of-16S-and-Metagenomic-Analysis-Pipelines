...
# Sum down columns → number of genera/phyla per sample
...
```{r}
PS_meta_relabund_filt.ord <- ordinate(PS_meta_relabund_filt, "PCoA")
PCoA2 = plot_ordination(PS_meta_relabund_filt, PS_meta_relabund_filt.ord, type="samples", color="Stage", title="taxa")
PCoA2 + 
  stat_ellipse(aes(fill = Stage), geom = "polygon", alpha = 0.2, color = NA) +
  geom_point(size = 3) +
  theme_classic()
